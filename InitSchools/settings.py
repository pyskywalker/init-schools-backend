"""
Django settings for InitSchools project.
...
SECRET_KEY = 'django-insecure-whm$7036f+j4v4muu!c7=+a(#rk!e)#r6bo9k0+7sbfnn_(0oh'
...
WSGI_APPLICATION = 'InitSchools.wsgi.application'
